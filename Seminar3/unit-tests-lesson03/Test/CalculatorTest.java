...
public class CalculatorTest {
    ...
    void computeLengthCircle() {
        Calculator calculator = new Calculator();
        assertThat(calculator.calculateLengthCircle(10)).isEqualTo(62.83185307179586);
        assertTrue(Math.abs(62 - calculator.calculateLengthCircle(10)) < 1); // 2 вариант, с округлением
    }
}